...
function checkAnswer(answerIndex) {
    ...
    if (answerIndex === currentQuestion.correctAnswer) {
        ...
        const funnyRemarks = [
            ...
            "Mathemagix says: 'Try again, mortal!'",
            "You're getting close... to a wrong answer!",
            "That's not the answer we're looking for... or is it?",
            "Your math skills are as flat as a pancake.",
            "Whoops! That answer is as useful as a chocolate teapot."
        ];
